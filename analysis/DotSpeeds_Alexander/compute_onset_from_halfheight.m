...
%
%  [ONSET_TIME, BOOTSTRAPPED_ERROR] = compute_onset_from_halfheight( SPIKETIMES, [EVENTTIMES=0], [BINWIDTH=0.1], [PRESTIM_TIME=0], [VERBOSE=false])
%
...
ind_halfmax = find(psth_rate>halfmax,1);
onset_time = bin_centers(ind_halfmax);
...
if verbose 
   ...
   logmsg(['Spontaneous rate = ' num2str(rate_spont)])
