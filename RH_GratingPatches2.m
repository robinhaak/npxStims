...
try
    ...
    for intDir = 1:numDirections
        ...
        theta_rad = deg2rad(mod(direction-180,360)); % Convert drift direction to radians
    ...
    while intThisTrial <= intTotalTrials && ~CheckEsc()
        ...
        currentDriftDirection = mod(sStimParams.vecDirections(vecDirectionIdx(intThisTrial))-180,360);
